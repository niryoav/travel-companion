...
export const oceaniaMarina2026TripData: TripData = {
  ...
  events: [
    ...
    },
    {
      ...
      scheduleStatus: 'TO_BE_CONFIRMED',
      meetingContext: 'Pickup time and exact cruise terminal to be confirmed',
      operationalNotes: [
        'Likely taxi; transfer is not yet arranged.',
        'Do not use a calculated leave-by time until pickup and terminal are confirmed.',
      ],
    },
    {
