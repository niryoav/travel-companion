...
// Coordinates are public town/port-center locations used only to request a
// general-area weather forecast; they are not a separate weather itinerary.
const locations: Location[] = [
  ...
  {
    id: 'location-greenock',
    name: 'Glasgow (Greenock)',
    city: 'Greenock',
    country: 'United Kingdom',
    latitude: 55.9483,
    longitude: -4.7658,
  ...
  {
    id: 'location-dun-laoghaire',
    name: 'Dublin (Dún Laoghaire)',
    city: 'Dún Laoghaire',
    country: 'Ireland',
    latitude: 53.294,
    longitude: -6.1344,
  ...
  {
    id: 'location-ringaskiddy',
    name: 'Cork (Ringaskiddy)',
    city: 'Ringaskiddy',
    country: 'Ireland',
    latitude: 51.8283,
    longitude: -8.3242,
...
export const oceaniaMarina2026TripData: TripData = {
  ...
  documentReferences: [
    ...
    {
      id: 'document-medical-declaration',
      title: 'Medical declaration for travel',
      category: 'MEDICAL',
      assetPath: '/documents/travel/medical-declaration.pdf',
      mimeType: 'application/pdf',
      associatedDate: '2026-08-22',
      dayId: 'day-2026-08-22',
      description:
        "Doctor's letter confirming the personal medication Yoav and Isabel carry during the trip.",
      actionLabel: 'Open medical declaration',
      offlineAvailable: true,
      verificationStatus: 'ISSUED',
    },
    {
      id: 'document-icelandair-coravin-approval',
      title: 'Icelandair approval — Coravin cartridges',
      category: 'FLIGHT',
      assetPath: '/documents/travel/icelandair-coravin-approval.pdf',
      mimeType: 'application/pdf',
      associatedDate: '2026-08-22',
      dayId: 'day-2026-08-22',
      description:
        'Icelandair confirmation approving two argon Coravin cartridges in carry-on or checked baggage.',
      actionLabel: 'Open Icelandair approval',
      offlineAvailable: true,
      verificationStatus: 'ISSUED',
    },
  ],
